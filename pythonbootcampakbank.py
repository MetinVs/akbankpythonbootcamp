...
def main():
    ...
    print("Kirves pizzayi hosgeldiniz")
    ...
    print("Siparisiniz",pizzaSiparis.tur,"içeriği ", pizzaSiparis.ingredients, " " , pizzaSiparis.size, " ", pizzaSiparis.cost,"tutar")
...
print("lütfen kart numarasını giriniz")
kartno = input("")
